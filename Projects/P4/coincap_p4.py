...
table = PrettyTable(['Name', 'Ticker' '% of total global cap', 'Current', '7.7T (Gold)', '36.6T (Narrow Money)', '73T (World Stock Markets)', '90.4T (Broad Money)', '217T (Real Estate)', '544T (Dervivatives)'])
...
for currency in data:
    ...
    trillion7price = '$' + locale.format_string('%.2f',trillion7price, True)
    trillion36price = '$' + locale.format_string('%.2f',trillion36price, True)
    trillion73price = '$' + locale.format_string('%.2f',trillion73price, True)
    trillion90price = '$' + locale.format_string('%.2f',trillion90price, True)
    trillion217price = '$' + locale.format_string('%.2f',trillion217price, True)
   # trillion544price = '$' + locale.format_string('%.2f',trillion544price, True)
